...
├── database/db_create.sql    # reference SQL schema (ORM auto-creates too)
├── shared/
...
│   ├── dispatcher.py         # least-loaded live server
│   ├── reaper.py             # failure-detection logging + ledger pruning
