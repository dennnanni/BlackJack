# BlackJack — Documentation (current architecture)

This documentation set describes the system **as it is today**, after the
simplification refactor ([docs/REFACTOR_PLAN.md](../docs/REFACTOR_PLAN.md)). The old
[docs/](../docs/README.md) folder documents the previous four-service architecture and
...
| 02 | [Central Server](02-central-server.md) | Accounts, login, dispatch, the game-server API, the reaper. |
